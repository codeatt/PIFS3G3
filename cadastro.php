    ...
    <form id="formCadastro" name="formCadastro" action="cadastro.php" method="post" enctype="multipart/form-data" autocomplete="off">
        ...
        <div class="row">
          ...
          <div class="col-md-6 form-group">
			...
			<span class="error"><?php echo $erroConfirmacao;?></span>
          </div>
        </div>
        <div class="row">
			...
			<span class="error"><?php echo $erroCpf;?></span>
          </div>
          <div class="col-md-4 form-group">
			...
			<span class="error"><?php echo $erroDataNascimento;?></span>
          </div>
          <div class="col-md-4 form-group">
            <p class="form-label" for="sexo">Sexo:</p>
			<label for="sexoMasculino"><input type="radio" name="sexo" id="sexoMasculino" value="M" <?php echo(($sexo === 'M' || !isset($sexo)) ? 'checked' : '') ?> />Masculino</label>
        ...
        <div class="row">
		  <div class="col-md-4 form-group">
			...
			<span class="error"><?php echo $erroCelular; ?></span>
          </div>
        </div>
        <div class="row">
  		  <div class="col-md-4 form-group">
			...
			<span class="error"><?php echo $erroCep;?></span>
          </div>
        ...
        <div class="row">
          <div class="col-md-6 form-group">
			...
			<span class="error"><?php echo $erroArquivo;?></span>
          </div>
          <div class="col-md-6 form-group">
            <br/>
            <label class="form-label" for="autorizacaoContato">
				<input type="checkbox" name="autorizacaoContato" id="autorizacaoContato" <?php echo($autorizacaoContato === 'F' ? 'checked' : '') ?> />
